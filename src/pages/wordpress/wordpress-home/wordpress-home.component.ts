...
export class WordpressHome {
	...
	ngOnInit() {
		this.getUser();
	  	this.pages = [
        { title: 'POSTS', component: WordpressPosts, icon: 'logo-wordpress', note: 'voir liste' },
        { title: 'SUGGESTIONS', component: WordpressMenusdujour, icon: 'document', note: 'voir liste'},
